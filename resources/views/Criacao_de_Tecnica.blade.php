    ...
    <div class="container-fluid min-vh-100 d-flex justify-content-center align-items-center">
        ...
        <div class="row bg-white rounded-4 shadow overflow-hidden"
            ...
            <div class="col-md-6 p-4">
                ...
                <div class="campo-flutuante mt-3">
                    <input type="number" class="form-control rounded-5" id="dano" name="dano"
                        placeholder="">
                ...
                <div class="campo-flutuante mt-3">
                    <input type="number" class="form-control rounded-5" id="nivel_minimo" name="nivel_minimo"
                        placeholder="">
                ...
                <div class="justify-content-center d-flex mt-4">
                    <button id="criar_tecnica" type="button" class="btn btn-primary rounded-5 px-4">
                        Criar Tecnica
                    </button>
                </div>
            </div>
